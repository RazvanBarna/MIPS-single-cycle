    ...
    entity RomInstructions1 is
      Port (clk : in std_logic ;
            counter : in std_logic_vector(4 downto 0);
            digits : out std_logic_vector(31 downto 0));
    end RomInstructions1;
    
    architecture Behavioral of RomInstructions1 is
    type matrix is array(0 to 31 ) of std_logic_vector(31 downto 0);
    signal m : matrix :=(
        B"000000_00000_00000_00001_00000_000001", -- add $1, $0, $0  (init contor bucla)   **0x0000 0801**
        B"000000_00000_00000_00111_00000_000001", -- add $7, $0, $0  (init contor nr pozitive) **0x0000 3801**
        ...
        B"100000_00111_00111_0000000000000001", -- addi $7, $7, 1 **0x80E7 0001**
        B"111110_00000000000000000000001101", -- j continue_loop **0xFC00 000D**
